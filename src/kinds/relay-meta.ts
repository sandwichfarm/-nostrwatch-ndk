...
export interface RelayMetaParsedAll {
    url?: string;
    observed?: number;
}

export interface RelayMetaParsedAllExtended extends RelayMetaParsedAll {
    [key: string]: RelayMetaParsed | string | number | undefined;
}
 ...
 * @extends NDKEvent
 */
export class RelayMeta extends RelayDiscovery {
    ...
    /**
     * @description Retrieves all metadata grouped by their respective key.
     * 
     ...
     */
    get all(): RelayMetaParsedAllExtended {
        const result: RelayMetaParsedAllExtended = {};
        result.url = this.url as string;
        result.observed = this.created_at;
    ...
    /**
     * @description Groups tags by a specific group and parses their values.
     * 
    ...
    /**
     * @description Sets or updates tags grouped by a specific group with provided values.
     * 
    ...
    /**
     * @description Casts a tag value to its appropriate type based on its content and optionally a key.
     * 
